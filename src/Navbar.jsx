...
import logo from "./logosin.png";
export default function Navbar() {
  return (
    <>
      <nav className="bg-[#201D1D] border-gray-200 ">
        <div className=" flex flex-wrap items-center justify-between mx-auto p-4  w-[90%] max-w-[1440px]">
